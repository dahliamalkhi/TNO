 ...
 * @lucene.experimental
 */
public class SecureSimpleTextStoredFieldsWriter extends SecureStoredFieldsWriter {
  ...
  public SecureSimpleTextStoredFieldsWriter(Directory directory, String segment, IOContext context) throws IOException {
