...
public final class FieldInfo {
  ...
  public FieldInfo(String name, boolean indexed, int number, boolean storeTermVector, boolean omitNorms,
    ...
    this(name,false,indexed,number,storeTermVector,omitNorms,storePayloads,indexOptions,docValues,normsType,attributes);
  }
   ...
   * @lucene.experimental
   */
  public FieldInfo(String name, boolean encrypted, boolean indexed, int number, boolean storeTermVector, boolean omitNorms,
      boolean storePayloads, IndexOptions indexOptions, DocValuesType docValues, DocValuesType normsType, 
      Map<String,String> attributes) {
    this.name = name;
  ...
  void update(IndexableFieldType ft) {
    update(ft.encrypted(), ft.indexed(), false, ft.omitNorms(), false, ft.indexOptions());
  }
  ...
  // should only be called by FieldInfos#addOrUpdate
  void update(boolean encrypted, boolean indexed, boolean storeTermVector, boolean omitNorms, boolean storePayloads, IndexOptions indexOptions) {
    //System.out.println("FI.update field=" + name + " indexed=" + indexed + " omitNorms=" + omitNorms + " this.omitNorms=" + this.omitNorms);
    if (this.encrypted != encrypted) {
      throw new IllegalArgumentException("cannot change encryption from " + this.encrypted + " to " + encrypted + " for field \"" + name + "\"");
    }
