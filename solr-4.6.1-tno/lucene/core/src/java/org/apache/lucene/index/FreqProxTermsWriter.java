...
final class FreqProxTermsWriter extends TermsHashConsumer {
  ...
  public void flush(Map<String,TermsHashConsumerPerField> fieldsToFlush, final SegmentWriteState state) throws IOException {
    ...
    //final FieldsConsumer secureConsumer = SecureCodec.getDefault().securePostingsFormat().fieldsConsumer(state);
...
//          fieldWriter.flush(fieldInfo.name, secureConsumer, state);
//        else
...
//        IOUtils.close(secureConsumer);
      } else {
        IOUtils.closeWhileHandlingException(consumer);
//        IOUtils.closeWhileHandlingException(secureConsumer);
      }
    }
  }
