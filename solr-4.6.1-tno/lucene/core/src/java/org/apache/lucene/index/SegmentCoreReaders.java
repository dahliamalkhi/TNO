...
import org.apache.lucene.codecs.secure.SecureStoredFieldsReader;
...
final class SegmentCoreReaders {
  ...
  //final FieldsProducer secureFields;
...
//  };
  ...
  SegmentCoreReaders(SegmentReader owner, Directory dir, SegmentCommitInfo si, IOContext context, int termsIndexDivisor) throws IOException {
    ...
    try {
      ...
      //secureFields = SecureCodec.getDefault().securePostingsFormat().fieldsProducer(segmentReadState);
      //assert secureFields != null;
