...
public class BlockTreeTermsReader extends FieldsProducer {
  ...
  public BlockTreeTermsReader(Directory dir, FieldInfos fieldInfos, SegmentInfo info,
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis() - StartTime) + " ms: " + segmentName + ": BlockTreeTermsReader: const: start\r\n");
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis() - StartTime) + " ms: " + info.name + ": BlockTreeTermsReader: const: end\r\n");
  }
  ...
  public Terms terms(String field) throws IOException {
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": BlockTreeTermsReader: terms: start " + field + "\r\n");
    Terms retVal = null;
    assert field != null;
    retVal = fields.get(field);
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": BlockTreeTermsReader: terms: end " + field + "\r\n");
    return retVal;
  }
  ...
  public final class FieldReader extends Terms {
    ...
    FieldReader(FieldInfo fieldInfo, long numTerms, BytesRef rootCode, long sumTotalTermFreq, long sumDocFreq, int docCount, long indexStartFP, IndexInput indexIn) throws IOException {
      if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": FieldReader: cons: start\r\n");
      ...
      if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": FieldReader: cons: end\r\n");
    }
    ...
    public TermsEnum iterator(TermsEnum reuse) throws IOException {
      if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": FieldReader: iterator: start " + reuse + "\r\n");
      TermsEnum retVal = new SegmentTermsEnum();
      if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": FieldReader: iterator: end " + reuse + "\r\n");
      return retVal;
    }
    ...
    private final class IntersectEnum extends TermsEnum {
      ...
      public IntersectEnum(CompiledAutomaton compiled, BytesRef startTerm) throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: cons: start\r\n");
        // if (DEBUG) {
        ...
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: cons: end\r\n");
      }
      ...
      public DocsEnum docs(Bits skipDocs, DocsEnum reuse, int flags) throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: docs: start " + term().utf8ToString() + "\r\n");
        currentFrame.decodeMetaData();
        DocsEnum retVal = postingsReader.docs(fieldInfo, currentFrame.termState, skipDocs, reuse, flags);
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: docs: end " + term().utf8ToString() + "\r\n");
        return retVal;
      }
      ...
      public DocsAndPositionsEnum docsAndPositions(Bits skipDocs, DocsAndPositionsEnum reuse, int flags) throws IOException {
        ...
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: docsAndPositions: start\r\n");
        currentFrame.decodeMetaData();
      ...
      public BytesRef next() throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: next: start\r\n");
          ...
          while (currentFrame.nextEnt == currentFrame.entCount) {
            if (!currentFrame.isLastInFloor) {
              ...
              if (currentFrame.ord == 0) {
                if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": IntersectEnum: next: end\r\n");
                return null;
              }
    ...
    private final class SegmentTermsEnum extends TermsEnum {
      ...
      public SegmentTermsEnum() throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: cons: start\r\n");
        ...
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: cons: end\r\n");
      }
      ...
      public boolean seekExact(final BytesRef target) throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: seekExact: start " + target.utf8ToString() + "\r\n");
        ...
        if (currentFrame != staticFrame) {
          ...
          if (cmp < 0) {
            ...
            if (termExists) {
              ...
              // }
              if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: seekExact: end " + target.utf8ToString() + "\r\n");
              return true;
            } else {
              // if (DEBUG) {
      ...
      public SeekStatus seekCeil(final BytesRef target) throws IOException {
        ...
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: seekCeil: start " + target.utf8ToString() + "\r\n");
        if (term.bytes.length <= target.length) {
          term.bytes = ArrayUtil.grow(term.bytes, 1+target.length);
        }
        ...
        if (currentFrame != staticFrame) {
          ...
          if (cmp < 0) {
            ...
            if (termExists) {
              ...
              //}
              if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: seekCeil: end " + target.utf8ToString() + "\r\n");
      ...
      @Override
      public BytesRef next() throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: next: start\r\n");
        ...
        while (currentFrame.nextEnt == currentFrame.entCount) {
          if (!currentFrame.isLastInFloor) {
            ...
            if (currentFrame.ord == 0) {
              ...
              currentFrame.rewind();
              termExists = false;
              if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: next: end\r\n");
              return null;
            }
            final long lastFP = currentFrame.fpOrig;
            currentFrame = stack[currentFrame.ord-1];
      ...
      @Override
      public DocsEnum docs(Bits skipDocs, DocsEnum reuse, int flags) throws IOException {
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: docs: start " + term().utf8ToString() + "\r\n");
        assert !eof;
        //if (DEBUG) {
        ...
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: docs: end " + term().utf8ToString() + "\r\n");
        return retVal;
      }
      ...
      public DocsAndPositionsEnum docsAndPositions(Bits skipDocs, DocsAndPositionsEnum reuse, int flags) throws IOException {
        ...
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: docsAndPositions: start " + term().utf8ToString() + "\r\n");
        assert !eof;
        currentFrame.decodeMetaData();
        DocsAndPositionsEnum retVal = postingsReader.docsAndPositions(fieldInfo, currentFrame.state, skipDocs, reuse, flags);
        if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SegmentTermsEnum: docsAndPositions: end " + term().utf8ToString() + "\r\n");
        return retVal;
      }
