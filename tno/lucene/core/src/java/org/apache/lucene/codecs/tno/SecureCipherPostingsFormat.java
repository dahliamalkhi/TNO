...
public final class SecureCipherPostingsFormat extends SecurePostingsFormat {
  ...
  public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
    ...
    boolean success = false;
    try {
      System.out.print("Dbg: " + (System.currentTimeMillis() - StartTime) + " ms: " + state.segmentInfo.name + ": BlockTreeTermsReader: const: start\r\n");
      ...
      System.out.print("Dbg: " + (System.currentTimeMillis() - StartTime) + " ms: " + state.segmentInfo.name + ": BlockTreeTermsReader: const: end\r\n");
      success = true;
      return ret;
    } finally {
      if (!success) {
  ...
  private static final SecureCipherPostingsFormat defaultFormat = new SecureCipherPostingsFormat();
  public static final SecureCipherPostingsFormat getDefault() { return defaultFormat; }
