...
public final class SecureCipherPostingsReader extends PostingsReaderBase {
  ...
  public SecureCipherPostingsReader(Directory dir, FieldInfos fieldInfos, SegmentInfo segmentInfo, IOContext ioContext, String segmentSuffix) throws IOException {
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SecureCipherPostingsReader: const: start\r\n");
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SecureCipherPostingsReader: const: end\r\n");
  }
  ...
  public DocsEnum docs(FieldInfo fieldInfo, BlockTermState termState, Bits liveDocs, DocsEnum reuse, int flags) throws IOException {
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SecureCipherPostingsReader: docs: start " + termState.docFreq + " " + termState.totalTermFreq + "\r\n");
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SecureCipherPostingsReader: docs: end " + termState.docFreq + " " + termState.totalTermFreq + "\r\n");
    return docsEnum;
  }
  ...
  public DocsAndPositionsEnum docsAndPositions(FieldInfo fieldInfo, BlockTermState termState, Bits liveDocs,
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SecureCipherTermsEnum: docsAndPositions: start\r\n");
    ...
    if (debug) System.out.print("Dbg: " + (System.currentTimeMillis()-StartTime) + " ms: " + segmentName + ": SecureCipherTermsEnum: docsAndPositions: end\r\n");
