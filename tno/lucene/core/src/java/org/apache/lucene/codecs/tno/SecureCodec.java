...
//  public SecureStoredFieldsFormat secureStoredFieldsFormat(Codec codec) { return secureStoredFieldsFormat(); }
  ...
  public DocValuesFormat docValuesFormat() { throw new NotImplementedException(); }

  @Override
  /** Encodes/decodes stored fields */
  public StoredFieldsFormat storedFieldsFormat() { throw new NotImplementedException(); }

  @Override
  /** Encodes/decodes term vectors */
  public TermVectorsFormat termVectorsFormat() { throw new NotImplementedException(); }

  @Override
  /** Encodes/decodes field infos file */
  public FieldInfosFormat fieldInfosFormat() { throw new NotImplementedException(); }

  @Override
  /** Encodes/decodes segment info file */
  public SegmentInfoFormat segmentInfoFormat() { throw new NotImplementedException(); }

  @Override
  /** Encodes/decodes document normalization values */
  public NormsFormat normsFormat() { throw new NotImplementedException(); }

  @Override
  /** Encodes/decodes live docs */
  public LiveDocsFormat liveDocsFormat() { throw new NotImplementedException(); }

  //private static SecureCodec defaultCodec = new SecureSimpleTextCodec();
  private static SecureCodec defaultCodec = new SecureCipherCodec(new Lucene46Codec());
