 ...
 *
 *  @lucene.experimental */
public final class SecureSimpleTextPostingsFormat extends SecurePostingsFormat {

  public SecureSimpleTextPostingsFormat() {
    super("SecureSimpleTextPostingsFormat");
  }
